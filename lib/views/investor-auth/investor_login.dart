...
import 'package:Seedfund/main.dart';
...
class InvestorLogin extends StatefulWidget {
  const InvestorLogin({Key? key}) : super(key: key);
            ...
            Container(
              ...
              child: ListView(
                ...
                children: <Widget>[
                  ...
                  const Text(
                    "Welcome back to your investor account on Seedfund",
                    style:
      ...
      await _auth
          ...
          .then((result) => {
                ...
                Navigator.of(context).pushReplacement(
                  MaterialPageRoute(
                    builder: (context) =>
                        InvestorPageRouting(uid: result.user!.uid),
                  ),
                ),
              });
    }
